 ...
 * @author maximen39
 */
public class MegawallsPlayingState extends ClassicPlayingState {
    @Override
    public void startStage(DuelsArena arena) {
        super.startStage(arena);
        arena.alivePlayers().forEach(profile -> {
            profile.player().setMaxHealth(44);
            profile.player().setHealth(44);
        });
    }
}
